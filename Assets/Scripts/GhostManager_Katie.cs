...
public class GhostManager_Katie : MonoBehaviour
{
    public static GhostManager_Katie Instance;
    ...
    //possibly this one??? maybe it's always returning something 
    private bool IsGhostInstantiated(Ghost ghost, Transform parent)
    {
        ...
        Debug.Log("isghostInstntiated is false"); 
        return false; 
    }
    ...
    private void InstantiateGhostButton(Ghost ghost, Transform parent)
    {
        ...
        Vector3 newObjectPosition = new Vector3(0, 0, parent.position.z - 1); 
       
        obj.transform.position = newObjectPosition; 
